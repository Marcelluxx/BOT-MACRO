...
from modules.models import (
    ClickBlock, DelayBlock, VisionScanBlock, SubMacroBlock, ScrollBlock, PeriodicBlock, DragBlock, ImageCheckBlock, LoopBlock,
...
class DraggableBlockTemplate(QFrame):
    ...
    def _create_default_block(self):
        ...
        elif self.block_type == BLOCK_IMAGE_CHECK:
            return ImageCheckBlock(image_path="", threshold=0.8)
        elif self.block_type == BLOCK_LOOP:
            return LoopBlock(iterations=3, children=[])
        return ClickBlock()
...
class ToolboxWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        for block_type in [BLOCK_CLICK, BLOCK_SCROLL, BLOCK_DRAG, BLOCK_DELAY, BLOCK_IMAGE_CHECK, BLOCK_VISION_SCAN, BLOCK_PERIODIC, BLOCK_LOOP, BLOCK_SUB_MACRO]:
